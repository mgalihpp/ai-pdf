...
interface PageProps {
  subscriptionsPlan: Awaited<ReturnType<typeof getUserSubscriptionPlan>>;
}

const Dashboard = ({subscriptionsPlan}: PageProps) => {
  ...
  return (
    <main className="mx-auto max-w-7xl md:p-10 p-5">
      <div className="mt-8 flex flex-col items-start justify-between gap-4 border-b border-gray-200 dark:border-gray-700 pb-5 sm:flex-row sm:items-center sm:gap-0">
        <h1 className="mb-3 font-bold text-5xl text-gray-900 dark:text-white">
          My Files
        </h1>

        <UploadButton isSubscribed={subscriptionsPlan.isSubscribed}/>
      </div>
